...
What comes next? [See more examples](./Play-Examples) and give TRBot a try! [Set up your own](./Setup-Init.md), or play through an instance deployed on a Twitch stream. [Players have achieved great feats with TRBot](./Real-Usage-Examples.md)!
