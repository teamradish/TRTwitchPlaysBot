    ...
    public static class DefaultData
    {
        ...
        public static List<CommandData> GetDefaultCommands()
        {
            ...
            List<CommandData> defaultCommands = new List<CommandData>()
            {
                ...
                new CommandData("creditlead", "TRBot.Commands.CreditLeaderboardCommand", userPerm, true, false),
                new CommandData("inputlead", "TRBot.Commands.InputLeaderboardCommand", userPerm, true, false),
