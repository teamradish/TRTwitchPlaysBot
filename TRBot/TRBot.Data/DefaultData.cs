    ...
    public static class DefaultData
    {
        ...
        public static List<CommandData> GetDefaultCommands()
        {
            List<CommandData> defaultCommands = new List<CommandData>()
            {
                ...
                new CommandData("documentation", "TRBot.Commands.MessageCommand", (long)PermissionLevels.User, true, true, SettingsConstants.DOCUMENTATION_MESSAGE),
                ...
                new CommandData("addinvalidcombo", "TRBot.Commands.AddInvalidInputComboCommand", (long)PermissionLevels.Moderator, true, true),
                new CommandData("removeinvalidcombo", "TRBot.Commands.RemoveInvalidInputComboCommand", (long)PermissionLevels.Moderator, true, true),
