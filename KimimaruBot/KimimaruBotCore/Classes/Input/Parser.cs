    ...
    public static class Parser
    {
        ...
        */
        ...
        public class Input
        {
            ...
            public string populate_variables(string macro_contents, List<string> variables)
            {
            ...
            public string populate_macros(string message)
            {
                ...
                while (count < MAX_RECURSION && found_macro == true)
                {
                    ...
                    if (subs.Count > 0)
                    {
                        ...
                        foreach (var current in subs)
                        {
                            ...
                            str += populate_variables(MACROS[current.Item1], current.Item3);
                            prev = current;
                        }
